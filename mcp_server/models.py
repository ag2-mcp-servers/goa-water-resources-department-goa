...
class CertificateParameters(BaseModel):
    ...
    Registration: str = Field(..., description='Registration No', examples=['1234'])
...
class ErcerCertificatePostRequest(BaseModel):
...
class ErcerCertificatePostResponse(BaseModel):
...
class ErcerCertificatePostResponse1(BaseModel):
...
class ErcerCertificatePostResponse2(BaseModel):
...
class ErcerCertificatePostResponse3(BaseModel):
...
class ErcerCertificatePostResponse4(BaseModel):
...
class ErcerCertificatePostResponse5(BaseModel):
...
class ErcerCertificatePostResponse6(BaseModel):
    error: Optional[Error6] = None
    errorDescription: Optional[ErrorDescription6] = None


class PfdawCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class PfdawCertificatePostResponse(BaseModel):
...
class PfdawCertificatePostResponse1(BaseModel):
...
class PfdawCertificatePostResponse2(BaseModel):
...
class PfdawCertificatePostResponse3(BaseModel):
...
class PfdawCertificatePostResponse4(BaseModel):
...
class PfdawCertificatePostResponse5(BaseModel):
...
class PfdawCertificatePostResponse6(BaseModel):
    error: Optional[Error13] = None
    errorDescription: Optional[ErrorDescription13] = None


class TpcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class TpcerCertificatePostResponse(BaseModel):
...
class TpcerCertificatePostResponse1(BaseModel):
...
class TpcerCertificatePostResponse2(BaseModel):
...
class TpcerCertificatePostResponse3(BaseModel):
...
class TpcerCertificatePostResponse4(BaseModel):
...
class TpcerCertificatePostResponse5(BaseModel):
...
class TpcerCertificatePostResponse6(BaseModel):
